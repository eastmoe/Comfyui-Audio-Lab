...
const T = {
    zh: {
        ...
        hero_subtitle: '11 个专业音频节点，覆盖音乐分析、信号处理、AI 翻唱、歌曲生成、语音转录、源分离、语音合成与 LLM 调用——在 ComfyUI 中构建端到端音频工作流',
        hero_cta1: '探索节点生态',
        hero_cta2: '一键安装',
        stat_nodes: '专业节点',
        ...
        nodes_title: '节点生态',
        nodes_subtitle: '11 个节点覆盖音频处理全链路，各自独立又无缝协作',
        wf_title: '联合工作流',
        ...
        cat_ai: 'AI 工具',
        wf0_title: 'AI 翻唱全流程',
        wf0_desc: '从一首原曲出发，分析 BPM、节拍、调性与和弦，分离人声与伴奏，用 AI 模型将人声转换为目标声线，再与伴奏混合并进行后期处理——完整的翻唱生产线。',
        wf0_s1: '输入原曲',
        wf0_s2: '分析节拍/调性',
        wf0_s3: '分离人声/伴奏',
        wf0_s4: '声线转换',
    ...
    en: {
        ...
        hero_subtitle: '11 professional audio nodes covering music analysis, signal processing, AI cover, song generation, speech transcription, source separation, speech synthesis & LLM — build end-to-end audio workflows in ComfyUI',
        ...
        nodes_subtitle: '11 nodes covering the full audio pipeline, independent yet seamlessly collaborative',
        ...
        wf0_desc: 'Start from an original song, analyze BPM, beats, key, and chords, separate vocals and accompaniment, convert vocals to target voice with AI, then mix and post-process — a complete cover production line.',
        wf0_s1: 'Input Song',
        wf0_s2: 'Analyze Beat/Key',
        wf0_s3: 'Separate Vocals',
        wf0_s4: 'Voice Conversion',
...
const workflows = [
    {
        ...
        steps: [
            ...
            { key: 'wf0_s4', icon: 'fa-microphone-lines', node: 'So-VITS / DDSP / RVC' },

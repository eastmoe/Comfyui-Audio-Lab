...
const T = {
    zh: {
        ...
        hero_subtitle: '10 个专业音频节点，覆盖音乐分析、信号处理、AI 翻唱、歌曲生成、语音转录、源分离、语音合成与 LLM 调用——在 ComfyUI 中构建端到端音频工作流',
        hero_cta1: '探索节点生态',
        hero_cta2: '一键安装',
        stat_nodes: '专业节点',
        ...
        nodes_title: '节点生态',
        nodes_subtitle: '10 个节点覆盖音频处理全链路，各自独立又无缝协作',
        wf_title: '联合工作流',
    ...
    en: {
        ...
        hero_subtitle: '10 professional audio nodes covering music analysis, signal processing, AI cover, song generation, speech transcription, source separation, speech synthesis & LLM — build end-to-end audio workflows in ComfyUI',
        ...
        nodes_subtitle: '10 nodes covering the full audio pipeline, independent yet seamlessly collaborative',
...
const workflows = [
    {
        ...
        steps: [
            ...
            { key: 'wf0_s4', icon: 'fa-microphone-lines', node: 'So-VITS / DDSP' },

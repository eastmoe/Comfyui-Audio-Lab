...
const T = {
    zh: {
        ...
        hero_subtitle: '12 个专业音频节点，覆盖音乐分析、信号处理、AI 翻唱、零样本歌声克隆、歌曲生成、语音转录、源分离、语音合成与 LLM 调用——在 ComfyUI 中构建端到端音频工作流',
        hero_cta1: '探索节点生态',
        hero_cta2: '一键安装',
        stat_nodes: '专业节点',
        ...
        nodes_title: '节点生态',
        nodes_subtitle: '12 个节点覆盖音频处理全链路，各自独立又无缝协作',
        wf_title: '联合工作流',
        ...
        node_analyst_title: 'Song Analyst',
        node_analyst_desc: '轻量音乐分析节点，输出 BPM、节拍、调性、和弦、结构分段、旋律 F0、情绪/风格标签与相似度结果，为翻唱、扒谱和歌曲生成提供参考。',
        ...
        node_rvc_title: 'Easy RVC',
        node_rvc_desc: '面向 ComfyUI 的纯推理 RVC 声线转换节点，原生支持 AUDIO、音高调整、FAISS 特征索引、多种 F0 方法，以及模型缓存和依赖权重自动下载。',
        node_soulx_title: 'Light SoulX-Singer',
        node_soulx_desc: '免训练、免微调的零样本歌声克隆节点，集成 SVS 歌声合成与 SVC 歌声转换，支持 F0/MIDI 精确控制、原生 AUDIO、按需加载与精简依赖。',
        ...
        cat_ai: 'AI 工具',
        wf0_title: 'AI 翻唱全流程',
        wf0_desc: '从一首原曲出发，分析 BPM、节拍、调性与和弦，分离人声与伴奏，再选择传统 SVC/RVC 或免训练的 SoulX-Singer 零样本克隆目标声线，最后完成混音与后期处理。',
        wf0_s1: '输入原曲',
        wf0_s2: '分析节拍/调性',
        wf0_s3: '分离人声/伴奏',
        wf0_s4: '声线转换/零样本克隆',
        ...
        wf0_s6: '输出翻唱',
        wf1_title: '从零创作歌曲',
        wf1_desc: '用 LLM 生成歌词，通过歌曲生成模型创作完整歌曲，再分析结构、节拍与和弦，拆分声部并进行精细混音处理——从灵感到成品。',
        wf1_s1: 'LLM 生成歌词',
        wf1_s2: '生成完整歌曲',
        wf1_s3: '分析结构/和弦',
        wf1_s4: '分离声部',
    ...
    en: {
        ...
        hero_subtitle: '12 professional audio nodes covering music analysis, signal processing, AI covers, zero-shot singing voice cloning, song generation, speech transcription, source separation, speech synthesis & LLM — build end-to-end audio workflows in ComfyUI',
        ...
        nodes_subtitle: '12 nodes covering the full audio pipeline, independent yet seamlessly collaborative',
        ...
        node_analyst_title: 'Song Analyst',
        node_analyst_desc: 'Lightweight music analysis nodes for BPM, beats, key, chords, structure segments, melody F0, mood/genre tags, and similarity results — useful references for covers, transcription, and song generation.',
        node_dsp_title: 'Audio DSP',
        ...
        node_rvc_title: 'Easy RVC',
        node_rvc_desc: 'Inference-focused RVC voice conversion for ComfyUI with native AUDIO, pitch control, FAISS feature retrieval, multiple F0 methods, model caching, and automatic dependency-weight downloads.',
        node_soulx_title: 'Light SoulX-Singer',
        node_soulx_desc: 'Zero-shot singing voice cloning with no per-singer training or fine-tuning, combining SVS synthesis and SVC conversion with precise F0/MIDI control, native AUDIO, lazy loading, and trimmed dependencies.',
        node_song_title: 'Easy SongGeneration',
        ...
        wf0_desc: 'Start from an original song, analyze BPM, beats, key, and chords, separate vocals and accompaniment, then choose classic SVC/RVC or training-free SoulX-Singer zero-shot cloning before mixing and post-processing.',
        wf0_s1: 'Input Song',
        wf0_s2: 'Analyze Beat/Key',
        wf0_s3: 'Separate Vocals',
        wf0_s4: 'Conversion / Zero-Shot Clone',
        wf0_s5: 'Mix & Post-Process',
        wf0_s6: 'Output Cover',
        wf1_title: 'Song from Scratch',
        wf1_desc: 'Generate lyrics with LLM, create a complete song, analyze structure, beats, and chords, then separate stems and fine-tune the mix — from inspiration to finished product.',
        wf1_s1: 'LLM Lyrics',
        wf1_s2: 'Generate Song',
        wf1_s3: 'Analyze Structure',
        wf1_s4: 'Separate Stems',
        wf1_s5: 'Fine-Tune Mix',
        wf1_s6: 'Output Track',
...
// ==================== 节点数据 ====================
const nodes = [
    { id: 'analyst', key: 'node_analyst', icon: 'fa-chart-line', cat: 'analysis', catKey: 'cat_analysis', repo: 'ComfyUI-Song-Analyst', color: '#2F9D9A' },
    ...
    { id: 'rvc', key: 'node_rvc', icon: 'fa-sliders', cat: 'cover', catKey: 'cat_cover', repo: 'ComfyUI-Easy-RVC', color: '#E85D75' },
    { id: 'soulx', key: 'node_soulx', icon: 'fa-wand-magic-sparkles', cat: 'cover', catKey: 'cat_cover', repo: 'ComfyUI-Light-SoulX-Singer', color: '#C45BE8' },
...
const workflows = [
    {
        ...
        steps: [
            ...
            { key: 'wf0_s2', icon: 'fa-chart-line', node: 'Song Analyst' },
            { key: 'wf0_s3', icon: 'fa-layer-group', node: 'MSST' },
            { key: 'wf0_s4', icon: 'fa-microphone-lines', node: 'So-VITS / DDSP / RVC / SoulX' },
            { key: 'wf0_s5', icon: 'fa-wave-square', node: 'Audio DSP' },
            { key: 'wf0_s6', icon: 'fa-check-circle', node: null },
        ]
    },
    {
        ...
        steps: [
            ...
            { key: 'wf1_s3', icon: 'fa-chart-line', node: 'Song Analyst' },
            { key: 'wf1_s4', icon: 'fa-layer-group', node: 'MSST' },
            { key: 'wf1_s5', icon: 'fa-wave-square', node: 'Audio DSP' },
            { key: 'wf1_s6', icon: 'fa-check-circle', node: null },
        ]
    },
    {
...
function renderNodes() {
    ...
    const catClass = { analysis: 'cat-analysis', processing: 'cat-processing', cover: 'cat-cover', song: 'cat-song', speech: 'cat-speech', ai: 'cat-ai' };
